package ru.progrm_jarvis.minecraft.commons.util.collection;
...
/**
 * A wrapper for {@link Iterator<E>} to be treated as a {@link Collection<E>}.
...
public class LazyIteratorToCollectionWrapper<E, C extends Collection<E>> implements Collection<E> {
     ...
     *
     * @return next element in iterator if any or {@link null} if its end was reached.
     */
     ...
     * @return found element reference if found and {@link null} false otherwise
     */
     ...
     * @return {@link true} if the element is contained in the wrapped iterator and {@link false} otherwise
     */
